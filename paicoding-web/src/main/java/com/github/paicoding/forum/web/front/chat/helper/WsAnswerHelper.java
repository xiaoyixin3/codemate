...
public class WsAnswerHelper {
    ...
    public void sendTaskPlanToUser(String session, String goal) {
        ChatRecordsVo res = chatFacade.autoChat(AISourceEnum.DEEP_SEEK,
                TaskPlanConstants.REQUEST_PREFIX + goal, vo -> response(session, vo));
        log.info("任务计划AI直接返回: {}", res);
    }
